...
comp4bank=startcash;
maxbet=50;
set(handles.pbankText, 'String', yourbank);
...
set(handles.pcard1Text, 'String', deal(6).str)
set(handles.pcard2Text, 'String', deal(7).str)
...
set(handles.card1Text, 'String', deal(1).str)
set(handles.card2Text, 'String', deal(2).str)
set(handles.card3Text, 'String', deal(3).str)
...
set(handles.potText, 'String', pot);
...
set(handles.card4Text, 'String', deal(4).str)
...
set(handles.card5Text, 'String', deal(5).str)
...
set(handles.directText, 'String', winner);
